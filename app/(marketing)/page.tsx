  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center mx-auto", textFont.className)}>
        ...
        high rises to the home office, the way you work is unique - accomplish
        it all with Intellitasks.
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Take me to Intellitasks</Link>
      </Button>
    </div>
  );
};
